...
<header>
	...
	<section id="login">              
              <form name="formulario" action="index2.php" method="post" onSubmit=" return validarCampos(this)">
                    <fieldset>
                        <legend>Login/Registro</legend>
                        <label for="usuario">Usuario:</label>
                        <input type="text" name="usuario" />
                        <label for="pass">Contrase&ntilde;a:</label>
                        <input type="password" name="pass"/>
                        <input type="submit" id = "aceptar" value = "Aceptar"/>
                        <a href="formulario2.php">&iexcl;Reg&iacute;strate!</a>
                    </fieldset>
                </form>
	</section>
	<nav id="menu">
